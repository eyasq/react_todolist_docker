    ...
    return(
      ...
      <div>
        ...
        <input
          ...
          {...register("username", {
            ...
            minLength: { value: 5, message: "Username must be 5 letters or more!" ,},
            maxLength:30
          })}
      ...
      <div>
        ...
        <input
          ...
          {...register("password", {
            ...
            minLength: { value: 8, message: "Password must be 8 letters or more, with uppercase, lowercase, and a symbol." },
      ...
      <div>
        ...
        <input
          ...
          id="cpassword"
          {...register("cpassword", {
            required: "Passwords dont match!",
            validate: (value)=> value === getValues('password') || "Passwords do not match"
          })}
          className="mt-1 block w-full rounded-lg border border-gray-300 p-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none"
        />
        {errors.cpassword && (
          <p className="mt-1 text-sm text-red-500">{errors.cpassword.message}</p>
        )}
      </div>
